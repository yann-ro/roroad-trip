...
<div style="position: absolute; top: 200px; width: 100%; text-align: center;">
  <img src="../images/ikarus-board.png" alt="Description of image" width="400">
</div>
...
<span class="profile-trigger">Adriana<span class="profile-card"><img src="../images/people/adriana.png" class="profile-pic"><span class="flag-overlay">🇲🇽</span></span></span> & <span class="profile-trigger">Foka<span class="profile-card"><img src="../images/people/foka.png" class="profile-pic"><span class="flag-overlay">🇮🇹</span></span></span> dirigent l'établissement où <span class="profile-trigger">[Anthar](https://www.instagram.com/antharracca/)<span class="profile-card"><img src="../images/people/anthar.png" class="profile-pic"><span class="flag-overlay">🇲🇽</span></span></span> leur fils, passe souvent pour s'entraîner.

* <span class="profile-trigger">Esteban<span class="profile-card"><img src="../images/people/esteban.png" class="profile-pic"><span class="flag-overlay">🇲🇽</span></span></span> manage l'école de kite:
  * les profs: <span class="profile-trigger">[Federico](https://www.instagram.com/fedebagnoli/)<span class="profile-card"><img src="../images/people/federico.png" class="profile-pic"><span class="flag-overlay">🇮🇹</span></span></span>,
  <span class="profile-trigger">[Mikey](https://www.instagram.com/mikeybarrillo/)<span class="profile-card"><img src="../images/people/mikey.png" class="profile-pic"><span class="flag-overlay">🇺🇸</span></span></span>,
  <span class="profile-trigger">[Sage](https://www.instagram.com/sageeee.k/)<span class="profile-card"><img src="../images/people/sage.png" class="profile-pic"><span class="flag-overlay">🇺🇸</span></span></span>,
  <span class="profile-trigger">[Belinda](https://www.instagram.com/belindacaribbeanlife.mx/)<span class="profile-card"><img src="../images/people/belinda.png" class="profile-pic"><span class="flag-overlay">🇲🇽</span></span></span>,
  <span class="profile-trigger">Kike<span class="profile-card"><img src="../images/people/kike.png" class="profile-pic"><span class="flag-overlay">🇲🇽</span></span></span>,
  <span class="profile-trigger">[Aldolfo](https://www.instagram.com/adolfre2manzano/)<span class="profile-card"><img src="../images/people/adolfo.png" class="profile-pic"><span class="flag-overlay">🇨🇴</span></span></span>.
  * au support/rescue, prêts à aider à tout moment à coup de jetski: <span class="profile-trigger">Alex<span class="profile-card"><img src="../images/people/alex.png" class="profile-pic"><span class="flag-overlay">🇲🇽</span></span></span>, <span class="profile-trigger">Jesus<span class="profile-card"><img src="../images/people/jesus.png" class="profile-pic"><span class="flag-overlay">🇲🇽</span></span></span>, <span class="profile-trigger">Juan<span class="profile-card"><img src="../images/people/juan.png" class="profile-pic"><span class="flag-overlay">🇲🇽</span></span></span>

* En Cuisine tout est dirigé par <span class="profile-trigger">Anna-Maria<span class="profile-card"><img src="../images/people/anna-maria.png" class="profile-pic"><span class="flag-overlay">🇮🇹</span></span></span> 
  * En cuisine: <span class="profile-trigger">Vicky<span class="profile-card"><img src="../images/people/vicky.png" class="profile-pic"><span class="flag-overlay">🇲🇽</span></span></span>, <span class="profile-trigger">Luis<span class="profile-card"><img src="../images/people/luis.png" class="profile-pic"><span class="flag-overlay">🇲🇽</span></span></span>, <span class="profile-trigger">Maria<span class="profile-card"><img src="../images/people/maria.png" class="profile-pic"><span class="flag-overlay">🇲🇽</span></span></span>, <span class="profile-trigger">Gris<span class="profile-card"><img src="../images/people/gris.png" class="profile-pic"><span class="flag-overlay">🇲🇽</span></span></span>
  * Au bar cocktail: <span class="profile-trigger">Yann<span class="profile-card"><img src="../images/people/yann.png" class="profile-pic"><span class="flag-overlay">🇲🇫</span></span></span> (l'aprem) et <span class="profile-trigger">Miguel<span class="profile-card"><img src="../images/people/miguel.png" class="profile-pic"><span class="flag-overlay">🇲🇽</span></span></span> le soir

et à la réception des clients c'est <span class="profile-trigger">Gloria<span class="profile-card"><img src="../images/people/gloria.png" class="profile-pic"><span class="flag-overlay">🇮🇹</span></span></span> qui s'occupe de tout.

## Le bar

<div style="text-align: center;">
  <img src="../images/bar-de-frutas.jpeg" alt="Description of image" width="600">
</div>
...
<table style="width: 100%; border-collapse: collapse; text-align: center; table-layout: fixed;">
  <tr>
    <td style="padding: 10px; width: 33.33%; vertical-align: top;">
      <img src="../images/coco-fresco.jpeg" alt="Ikarus" width="200" style="max-width: 100%; height: auto;">
      <br>
      <i style="font-size: 0.9rem;"><b>Ikarus</b><br>On mixe: 1/4 concombre, 5xbasilic, 1 shot Bacardi, 4xglaçons</i>
    </td>
    <td style="padding: 10px; width: 33.33%; vertical-align: top;">
      <img src="../images/coco-fresco.jpeg" alt="Piña Colada" width="200" style="max-width: 100%; height: auto;">
      <br>
      <i style="font-size: 0.9rem;"><b>Piña Colada</b><br>On mixe: 100G d'anas gelés, 1 shot de Bacardi, crème de coco</i>
    </td>
    <td style="padding: 10px; width: 33.33%; vertical-align: top;">
      <img src="../images/coco-fresco.jpeg" alt="Suero" width="200" style="max-width: 100%; height: auto;">
      <br>
...
<table style="width: 100%; border-collapse: collapse; text-align: center;">
  <tr>
    <td style="padding: 10px; width: 33.33%; vertical-align: top;">
      <img src="../images/coco-fresco.jpeg" alt="Coco Fresco" width="200" style="max-width: 100%; height: auto;">
      <br>
      <i style="font-size: 0.9rem;"><b>Coco Fresco</b><br>Deux coup de couteaux, puis on fait un trou, et hop une paille</i>
    </td>
    <td style="padding: 10px; width: 33.33%; vertical-align: top;">
      <img src="../images/coco-fresco.jpeg" alt="Açai" width="200" style="max-width: 100%; height: auto;">
      <br>
    ...
    <td style="padding: 10px; width: 33.33%; vertical-align: top;">
      <img src="../images/coco-fresco.jpeg" alt="Smoothie" width="200" style="max-width: 100%; height: auto;">
      <br>
...
Nombre de jours de vents moyens par mois:
  <div style="text-align: center;">
    <img src="../images/ikarus-windguru.png" alt="Description of image" width="800">
  </div>
...
Donc le plus souvent c'est une aile de 12m2 et quand le vent du nord souffle on prend une 8m2.
  ...
  <div style="text-align: center;">
    <img src="../images/ikarus-school.jpeg" alt="Description of image" width="600">
  </div>
