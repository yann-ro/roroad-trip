...
<!-- <img src="assets/images/stitch.gif" style="position: fixed; top: 10px; left: 50%; height: 150px; z-index: 9999; " alt="My Animation"> -->

<a href="assets/subpages/dans-ma-valise.html" target="_blank" style="position: fixed; left: 15%; bottom: 110px; z-index: 10000">
  <img src="assets/images/stitch.gif" class="to-click" style="width: 100px">
</a>

<div id="musc">
  <iframe id="sc-player" style="position: fixed; left: 0px; bottom: 1.1rem; z-index: 999999" width="20%" height="100" scrolling="no" frameborder="no" allow="autoplay" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/82616537&color=%23ff5500&auto_play=true"></iframe>
</div>
